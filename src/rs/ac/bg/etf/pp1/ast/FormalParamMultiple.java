...
public class FormalParamMultiple extends FormalParamList {

    private FormalParam FormalParam;
    private FormalParamList FormalParamList;

    public FormalParamMultiple (FormalParam FormalParam, FormalParamList FormalParamList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormalParamMultiple(\n");
